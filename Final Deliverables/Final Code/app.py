...
def login():
    if request.method == 'POST':
        ...
        if result > 0:
            ...
            #compare passwords
            print("p",password.strip())
            password=password.strip()
            print("ssad",password_candidate)
            print(password.strip()==password_candidate)
            if password==password_candidate or str(password)==str(password_candidate):
                #Passed
